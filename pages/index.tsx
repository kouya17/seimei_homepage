  ...
  return (
    <div className='dark:bg-zinc-800 dark:text-gray-200'>
      ...
      <main className='flex-grow container max-w-lg mx-auto px-4 flex flex-col'>
        ...
        <Image src="/seimei_logo.png" alt="logo" width={500} height={250}/>
        ...
        <div className='py-2'>
          組み込み機器の開発からウェブサービスの開発まで、ソフトウェアの知識が必要になる領域は多岐に渡ります。清明ソフト開発はソフトウェア及びその周辺を含め、全体最適を追及したサービスの提供を進めてまいります。
        </div>
