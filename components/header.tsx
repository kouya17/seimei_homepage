...
export default function Header({ navs }: {navs: {text: string, href: string}[]}) {
  return (
    <header>
      <nav className="px-4 lg:px-6 py-2.5 border-gray-200 dark:border-gray-500 border-b">
        <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
          <Link href="/">
            <a className="dark:text-gray-300">清明ソフト開発</a>
          </Link>
